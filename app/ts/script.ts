...
const p1: Pessoa = new Pessoa('Walter', 30, new Date());
const pFisica: PessoaFisica = new PessoaFisica('Will', 30, new Date(), '123.456.789-00');
const pJuridica: PessoaJuridica = new PessoaJuridica('Walter', 30, new Date(), '123.456.789/0001-00');
